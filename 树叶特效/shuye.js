(function() {
    var z = function() { (function(j, l) {
            function q(a, b, d) {
                if (d === l && a.nodeType === 1) if (d = "data-" + b.replace(db, "$1-$2").toLowerCase(), d = a.getAttribute(d), typeof d === "string") {
                    try {
            ...
            function u(a, b, d) {
                ...
                g = b + "mark",
                h = c.data(a, e, l, true);
                h && (d === "queue" || !c.data(a, f, l, true)) && (d === "mark" || !c.data(a, g, l, true)) && setTimeout(function() { ! c.data(a, f, l, true) && !c.data(a, g, l, true) && (c.removeData(a, e, true), h.resolve())
                },
                0)
            }
            function w() {
            ...
            function ea(a) {
                ...
                if (! (a.liveFired === this || !g || !g.live || a.target.disabled || a.button && a.type === "click")) {
                    ...
                    for (k = 0; k < s.length; k++) g = s[k],
                    g.origType.replace(fa, "") === a.type ? f.push(g.selector) : s.splice(k--, 1);
                    f = c(a.target).closest(f, a.currentTarget);
                    for (o = 0, p = f.length; o < p; o++) {
                        l = f[o];
                        for (k = 0; k < s.length; k++) if (g = s[k], l.selector === g.selector && (!j || j.test(g.namespace)) && !l.elem.disabled) {
                            h = l.elem;
                            e = null;
                            if (g.preType === "mouseenter" || g.preType === "mouseleave") a.type = g.preType,
                            (e = c(a.relatedTarget).closest(g.selector)[0]) && c.contains(h, e) && (e = h); (!e || e !== h) && m.push({
                                elem: h,
                                handleObj: g,
                                level: l.level
                            })
                    ...
                    for (o = 0, p = m.length; o < p; o++) {
                        ...
                        if (j === false || a.isPropagationStopped()) if (d = f.level, j === false && (b = false), a.isImmediatePropagationStopped()) break
                    }
                    return b
                }
            }
            ...
            function ya(a, b, d) {
                ...
                f = b === "width" ? jb: kb;
                if (e > 0) return d !== "border" && c.each(f,
                function() {
            ...
            function za(a) {
                return function(b, d) {
                    ...
                    if (c.isFunction(d)) for (var e = b.toLowerCase().split(Aa), f = 0, g = e.length, h, k; f < g; f++) h = e[f],
                    (k = /^\+/.test(h)) && (h = h.substr(1) || "*"),
                    o = a[h] = a[h] || [],
                    h = o,
                    h[k ? "unshift": "push"](d)
                }
            ...
            function Z(a, b, c, e, f, g) {
                ...
                g = g || {};
                g[f] = true;
                for (var f = a[f], h = 0, k = f ? f.length: 0, o = a === ga, p; h < k && (o || !p); h++) p = f[h](b, c, e),
                typeof p === "string" && (!o || g[p] ? p = l: (b.dataTypes.unshift(p), p = Z(a, b, c, e, p, g)));
            ...
            function ha(a, b, d, e) {
                ...
                else if (!d && b != null && typeof b === "object") for (var f in b) ha(a + "[" + f + "]", b[f], d, e);
                else e(a, b)
            }
            function Ca() {
                try {
            ...
            function Fa(a) {
                if (!ia[a]) {
                    ...
                    d.remove();
                    if (e === "none" || e === "") {
                        if (!E) E = m.createElement("iframe"),
                        E.frameBorder = E.width = E.height = 0;
                        b.appendChild(E);
                        if (!J || !E.createElement) J = (E.contentWindow || E.contentDocument).document,
                        J.write((m.compatMode === "CSS1Compat" ? "<!doctype html>": "") + "<html><body>"),
                        J.close();
                        d = J.createElement(a);
            ...
            c = function() {
                ...
                b.fn = b.prototype = {
                    ...
                    init: function(a, c, d) {
                        ...
                        this.length = 1,
                        this;
                        if (a === "body" && !c && m.body) return this.context = m,
                        this[0] = m.body,
                        this.selector = a,
                        this.length = 1,
                        this;
                        if (typeof a === "string") if ((e = a.charAt(0) === "<" && a.charAt(a.length - 1) === ">" && a.length >= 3 ? [null, a, null] : g.exec(a)) && (e[1] || !c)) if (e[1]) return d = (c = c instanceof b ? c[0] : c) ? c.ownerDocument || c: m,
                        (a = V.exec(a)) ? b.isPlainObject(c) ? (a = [m.createElement(a[1])], b.fn.attr.call(a, c, true)) : a = [d.createElement(a[1])] : (a = b.buildFragment([e[1]], [d]), a = (a.cacheable ? b.clone(a.fragment) : a.fragment).childNodes),
                        b.merge(this, a);
                        else {
                        ...
                        if (a.selector !== l) this.selector = a.selector,
                    ...
                    pushStack: function(a, c, d) {
                        ...
                        else if (c) e.selector = this.selector + "." + c + "(" + d + ")";
                        return e
                    },
                    each: function(a, c) {
                ...
                b.extend = b.fn.extend = function() {
                    ...
                    h = arguments.length,
                    t = false;
                    typeof g === "boolean" && (t = g, g = arguments[1] || {},
                    x = 2);
                    typeof g !== "object" && !b.isFunction(g) && (g = {});
                    h === x && (g = this, --x);
                    for (; x < h; x++) if ((a = arguments[x]) != null) for (c in a) d = g[c],
                    e = a[c],
                    g !== e && (t && e && (b.isPlainObject(e) || (f = b.isArray(e))) ? (f ? (f = false, d = d && b.isArray(d) ? d: []) : d = d && b.isPlainObject(d) ? d: {},
                    g[c] = b.extend(t, d, e)) : e !== l && (g[c] = e));
                    return g
                };
                b.extend({
                    ...
                    bindReady: function() {
                        if (!aa) {
                            ...
                            if (m.addEventListener) m.addEventListener("DOMContentLoaded", T, false),
                    ...
                    map: function(a, c, d) {
                        ...
                        x = 0,
                        h = a.length;
                        if (a instanceof b || h !== l && typeof h === "number" && (h > 0 && a[0] && a[h - 1] || h === 0 || b.isArray(a))) for (; x < h; x++) e = c(a[x], x, d),
                        e != null && (g[g.length] = e);
            ...
            c.extend({
                _Deferred: function() {
                    ...
                    f = {
                            ...
                            if (!e) {
                                ...
                                h, k, o, p, l;
                                b && (l = b, b = 0);
                                for (h = 0, k = d.length; h < k; h++) o = d[h],
                                p = c.type(o),
                                p === "array" ? f.done.apply(f, o) : p === "function" && a.push(o);
                            ...
                            return c.Deferred(function(e) {
                                ...
                                function(a, d) {
                                    ...
                                    if (c.isFunction(f)) b[a](function() {
                                        if ((l = f.apply(this, arguments)) && c.isFunction(l.promise)) l.promise().then(e.resolve, e.reject);
                ...
                when: function(a) {
                    function b(a) {
                        return function(b) {
                            d[a] = arguments.length > 1 ? Ia.call(arguments, 0) : b; --g || h.resolveWith(h, Ia.call(d, 0))
                        }
                    }
                    var d = arguments,
                    e = 0,
                    f = d.length,
                    g = f,
                    h = f <= 1 && a && c.isFunction(a.promise) ? a: c.Deferred();
                    if (f > 1) {
            ...
            c.support = function() {
                ...
                if ("zoom" in a.style) a.style.display = "inline",
                a.style.zoom = 1,
                h.inlineBlockNeedsLayout = a.offsetWidth === 2,
                a.style.display = "",
                ...
                a.innerHTML = "";
                if (m.defaultView && m.defaultView.getComputedStyle) d = m.createElement("div"),
                d.style.width = "0",
                d.style.marginRight = "0",
                a.appendChild(d),
                h.reliableMarginRight = (parseInt((m.defaultView.getComputedStyle(d, null) || {
                    marginRight: 0
                }).marginRight, 10) || 0) === 0;
                e.innerHTML = "";
                b.removeChild(e);
                if (a.attachEvent) for (k in {
                    submit: 1,
                    change: 1,
                    focusin: 1
                }) b = "on" + k,
                d = b in a,
                d || (a.setAttribute(b, "return;"), d = typeof a[b] === "function"),
                h[k + "Bubbles"] = d;
            ...
            c.extend({
                ...
                data: function(a, b, d, e) {
                    if (c.acceptData(a)) {
                        ...
                        h = a.nodeType,
                        k = h ? c.cache: a,
                        o = h ? a[c.expando] : a[c.expando] && c.expando;
                ...
                removeData: function(a, b, d) {
                    if (c.acceptData(a)) {
                        ...
                        if (h[k]) {
                            if (b && (e = d ? h[k][f] : h[k])) if (e[b] || (b = c.camelCase(b)), delete e[b], !r(e)) return;
            ...
            c.fn.extend({
                data: function(a, b) {
                    ...
                    if (typeof a === "undefined") {
                        if (this.length && (d = c.data(this[0]), this[0].nodeType === 1)) for (var e = this[0].attributes, f, g = 0, h = e.length; g < h; g++) f = e[g].name,
                        f.indexOf("data-") === 0 && (f = c.camelCase(f.substring(5)), q(this[0], f, d[f]));
                        return d
                    ...
                    var k = a.split(".");
                    k[1] = k[1] ? "." + k[1] : "";
                    return b === l ? (d = this.triggerHandler("getData" + k[1] + "!", [k[0]]), d === l && this.length && (d = c.data(this[0], a), d = q(this[0], a, d)), d === l && k[1] ? this.data(k[0]) : d) : this.each(function() {
                        var d = c(this),
                        e = [k[0], b];
            ...
            c.extend({
                ...
                _unmark: function(a, b, d) {
                    ...
                    if (b) {
                        var d = d || "fx",
                        e = d + "mark"; (a = a ? 0 : (c.data(b, e, l, true) || 1) - 1) ? c.data(b, e, a, true) : (c.removeData(b, e, true), u(b, d, "mark"))
                    }
                },
                ...
                dequeue: function(a, b) {
                    ...
                    d.length || (c.removeData(a, b + "queue", true), u(a, b, "queue"))
                }
            });
            c.fn.extend({
                queue: function(a, b) {
                ...
                promise: function(a) {
                    ...
                    k = a + "queue";
                    a += "mark";
                    for (var o; f--;) if (o = c.data(e[f], h, l, true) || (c.data(e[f], k, l, true) || c.data(e[f], a, l, true)) && c.data(e[f], h, c._Deferred(), true)) g++,
                    o.done(b);
                    b();
                    return d.promise()
                }
            ...
            c.fn.extend({
                ...
                addClass: function(a) {
                    ...
                    if (a && typeof a === "string") {
                        b = a.split(na);
                        for (d = 0, e = this.length; d < e; d++) if (f = this[d], f.nodeType === 1) if (!f.className && b.length === 1) f.className = a;
                        else {
                            g = " " + f.className + " ";
                ...
                toggleClass: function(a, b) {
                    ...
                    return c.isFunction(a) ? this.each(function(d) {
                        ...
                        if (d === "string") for (var f, g = 0,
                        h = c(this), k = b, o = a.split(na); f = o[g++];) k = e ? k: !h.hasClass(f),
                ...
                hasClass: function(a) {
                    for (var a = " " + a + " ",
                    b = 0,
                    c = this.length; b < c; b++) if (this[b].nodeType === 1 && (" " + this[b].className + " ").replace(Ja, " ").indexOf(a) > -1) return true;
                    return false
                },
                val: function(a) {
                    var b, d, e = this[0];
                    if (!arguments.length) {
                        if (e) {
                            ...
                            d = e.value;
                            return typeof d === "string" ? d.replace(sb, "") : d == null ? "": d
                        }
                        return l
                    }
                    ...
                    return this.each(function(d) {
                        var e = c(this);
                        if (this.nodeType === 1 && (d = f ? a.call(this, d, e.val()) : a, d == null ? d = "": typeof d === "number" ? d += "": c.isArray(d) && (d = c.map(d,
                        function(a) {
                            return a == null ? "": a + ""
            ...
            c.extend({
                valHooks: {
                    ...
                    select: {
                        get: function(a) {
                            ...
                            a = a.type === "select-one";
                            if (d < 0) return null;
                            for (var g = a ? d: 0, h = a ? d + 1 : f.length; g < h; g++) if (b = f[g], b.selected && (c.support.optDisabled ? !b.disabled: b.getAttribute("disabled") === null) && (!b.parentNode.disabled || !c.nodeName(b.parentNode, "optgroup"))) {
                                b = c(b).val();
                                if (a) return b;
                                e.push(b)
                            }
                ...
                attr: function(a, b, d, e) {
                    ...
                    var g, h;
                    if (e = f !== 1 || !c.isXMLDoc(a)) b = c.attrFix[b] || b,
                    (h = c.attrHooks[b]) || (Ka.test(b) ? h = La: K && (h = K));
                    return d !== l ? d === null ? (c.removeAttr(a, b), l) : h && "set" in h && e && (g = h.set(a, d, b)) !== l ? g: (a.setAttribute(b, "" + d), d) : h && "get" in h && e && (g = h.get(a, b)) !== null ? g: (g = a.getAttribute(b), g === null ? l: g)
                },
                ...
                prop: function(a, b, d) {
                    var e = a.nodeType;
                    if (!a || e === 3 || e === 8 || e === 2) return l;
                    var f, g;
                    if (e !== 1 || !c.isXMLDoc(a)) b = c.propFix[b] || b,
                    g = c.propHooks[b];
            ...
            La = {
                get: function(a, b) {
                    var d;
                    return c.prop(a, b) === true || (d = a.getAttributeNode(b)) && d.nodeValue !== false ? b.toLowerCase() : l
                },
                set: function(a, b, d) {
            ...
            c.event = {
                ...
                remove: function(a, b, d, e) {
                    if (! (a.nodeType === 3 || a.nodeType === 8)) {
                        ...
                        if (s && q) {
                            ...
                            b = b.type;
                            if (!b || typeof b === "string" && b.charAt(0) === ".") for (f in b = b || "", q) c.event.remove(a, f + b);
                            else {
                                for (b = b.split(" "); f = b[h++];) if (j = f, k = f.indexOf(".") < 0, o = [], k || (o = f.split("."), f = o.shift(), p = RegExp("(^|\\.)" + c.map(o.slice(0).sort(), xb).join("\\.(?:.*\\.)?") + "(\\.|$)")), m = q[f]) if (d) {
                                    j = c.event.special[f] || {};
                                    for (g = e || 0; g < m.length; g++) if (B = m[g], d.guid === B.guid) {
                                        if (k || p.test(B.namespace)) e == null && m.splice(g--, 1),
                                        j.remove && j.remove.call(a, B);
                                        if (e != null) break
                                    }
                                    if (m.length === 0 || e != null && m.length === 1)(!j.teardown || j.teardown.call(a, o) === false) && c.removeEvent(a, f, s.handle),
                                    delete q[f]
                                } else for (g = 0; g < m.length; g++) if (B = m[g], k || p.test(B.namespace)) c.event.remove(a, j, B.handler, g),
                                m.splice(g--, 1);
                        ...
                        if (d) {
                            if (! (d.nodeType === 3 || d.nodeType === 8)) {
                                ...
                                do {
                                    ...
                                    a.currentTarget = g;
                                    h && h.apply(g, b);
                                    if (e && c.acceptData(g) && g[e] && g[e].apply(g, b) === false) a.result = false, a.preventDefault();
                ...
                handle: function(a) {
                    ...
                    g = b.length; f < g; f++) {
                        ...
                        if (d || a.namespace_re.test(h.namespace)) {
                            ...
                            if (h !== l) a.result = h,
                            h === false && (a.preventDefault(), a.stopPropagation());
                ...
                fix: function(a) {
                    ...
                    if (a.pageX == null && a.clientX != null) d = a.target.ownerDocument || m,
                    b = d.documentElement,
                    d = d.body,
            ...
            var Ma = function(a) {
                ...
                e = a.type;
                a.type = a.data;
                if (b !== this && (b && (d = c.contains(this, b)), !d)) c.event.handle.apply(this, arguments),
                a.type = e
            },
            Na = function(a) {
                a.type = a.data;
            ...
            if (!c.support.submitBubbles) c.event.special.submit = {
                setup: function() {
                    ...
                    function(a) {
                        var b = a.target,
                        d = c.nodeName(b, "input") ? b.type: ""; (d === "submit" || d === "image") && c(b).closest("form").length && z("submit", this, arguments)
                    }),
                    c.event.add(this, "keypress.specialSubmit",
                    function(a) {
                        var b = a.target,
                        d = c.nodeName(b, "input") ? b.type: ""; (d === "text" || d === "password") && c(b).closest("form").length && a.keyCode === 13 && z("submit", this, arguments)
                    })
                },
                teardown: function() {
            ...
            if (!c.support.changeBubbles) {
                ...
                ba = function(a, b) {
                    var d = a.target,
                    e, f;
                    if (oa.test(d.nodeName) && !d.readOnly && (e = c._data(d, "_change_data"), f = Oa(d), (a.type !== "focusout" || d.type !== "radio") && c._data(d, "_change_data", f), !(e === l || f === e))) if (e != null || f) a.type = "change",
                    a.liveFired = l,
                ...
                c.event.special.change = {
                    filters: {
                        ...
                        click: function(a) {
                            var b = a.target,
                            d = c.nodeName(b, "input") ? b.type: ""; (d === "radio" || d === "checkbox" || c.nodeName(b, "select")) && ba.call(this, a)
                        },
                        keydown: function(a) {
                            var b = a.target,
                            d = c.nodeName(b, "input") ? b.type: ""; (a.keyCode === 13 && !c.nodeName(b, "textarea") || a.keyCode === 32 && (d === "checkbox" || d === "radio") || d === "select-multiple") && ba.call(this, a)
                        },
            ...
            function(a, b) {
                ...
                c.event.special[b] = {
                    ...
                    teardown: function() {--e === 0 && m.removeEventListener(a, d, true)
                    }
                }
            });
            c.each(["bind", "one"],
            function(a, b) {
                c.fn[b] = function(a, e, f) {
                    ...
                    if (arguments.length === 2 || e === false) f = e,
                    e = l;
                    b === "one" ? (g = function(a) {
                        c(this).unbind(a, g);
            ...
            function(a, b) {
                c.fn[b] = function(a, e, f, g) {
                    ...
                    if (b === "die" && !a && g && g.charAt(0) === ".") return j.unbind(g),
                    this;
                    if (e === false || c.isFunction(e)) f = e || w,
                    e = l;
                    for (a = (a || "").split(" "); (g = a[h++]) != null;) if (k = fa.exec(g), o = "", k && (o = k[0], g = g.replace(fa, "")), g === "hover") a.push("mouseenter" + o, "mouseleave" + o);
                    else if (k = g, pa[g] ? (a.push(pa[g] + o), g += o) : g = (pa[g] || g) + o, b === "live") {
                        o = 0;
                        for (var m = j.length; o < m; o++) c.event.add(j[o], "live." + X(g, p), {
                            data: e,
                            selector: p,
                            handler: f,
                            origType: g,
            ...
            function(a, b) {
                ...
                var p = function(a, b, c, e) {
                    ...
                    w = a;
                    do
                    if (d.exec(""), h = d.exec(w)) if (w = h[3], v.push(h[1]), h[2]) {
                        l = h[3];
                        break
                    }
                    while (h);
                    if (v.length > 1 && q.exec(a)) if (v.length === 2 && j.relative[v[0]]) k = y(v[0] + v[1], b);
                    else for (k = j.relative[v[0]] ? [b] : p(v.shift(), b); v.length;) a = v.shift(),
                    ...
                    k = y(a, k);
                        ...
                        k = h.expr ? p.filter(h.expr, h.set) : h.set;
                        for (v.length > 0 ? o = r(k) : B = false; v.length;) h = s = v.pop(),
                        j.relative[s] ? h = v.pop() : s = "",
                        h == null && (h = b),
                        j.relative[s](o, h, A)
                    } else o = [];
                    o || (o = k);
                    o || p.error(s || a);
                    if (f.call(o) === "[object Array]") if (B) if (b && b.nodeType === 1) for (a = 0; o[a] != null; a++) o[a] && (o[a] === true || o[a].nodeType === 1 && p.contains(b, o[a])) && c.push(k[a]);
                    else for (a = 0; o[a] != null; a++) o[a] && o[a].nodeType === 1 && c.push(k[a]);
                ...
                p.uniqueSort = function(a) {
                    if (w && (g = h, a.sort(w), g)) for (var b = 1; b < a.length; b++) a[b] === a[b - 1] && a.splice(b--, 1);
                    return a
                };
                ...
                p.filter = function(a, b, c, d) {
                    for (var e, f, g = a,
                    h = [], k = b, o = b && b[0] && p.isXML(b[0]); a && b.length;) {
                        for (var m in j.filter) if ((e = j.leftMatch[m].exec(a)) != null && e[2]) {
                            ...
                            if (v.substr(v.length - 1) !== "\\") {
                                k === h && (h = []);
                                if (j.preFilter[m]) if (e = j.preFilter[m](e, k, c, h, d, o)) {
                                    if (e === true) continue
                                } else f = s = true;
                                if (e) for (var q = 0; (v = k[q]) != null; q++) if (v) {
                                    s = r(v, e, q, k);
                                    var B = d ^ !!s;
                                    c && s != null ? B ? f = true: k[q] = false: B && (h.push(v), f = true)
                                }
                                if (s !== l) {
                                    c || (k = h);
                ...
                var j = p.selectors = {
                    ...
                    relative: {
                        ...
                        ">": function(a, b) {
                            ...
                            e = 0,
                            f = a.length;
                            if (d && !o.test(b)) for (b = b.toLowerCase(); e < f; e++) {
                    ...
                    preFilter: {
                        CLASS: function(a, b, c, d, e, f) {
                            ...
                            if (f) return a;
                            for (var f = 0,
                            g; (g = b[f]) != null; f++) g && (e ^ (g.className && (" " + g.className + " ").replace(/[\t\n\r]/g, " ").indexOf(a) >= 0) ? c || d.push(g) : c && (b[f] = false));
                            return false
                        },
                        ID: function(a) {
                        ...
                        ATTR: function(a, b, c, d, e, f) {
                            b = a[1] = a[1].replace(k, ""); ! f && j.attrMap[b] && (a[1] = j.attrMap[b]);
                            a[4] = (a[4] || a[5] || "").replace(k, "");
                            a[2] === "~=" && (a[4] = " " + a[4] + " ");
                            return a
                        },
                        PSEUDO: function(a, b, c, e, f) {
                            if (a[1] === "not") if ((d.exec(a[3]) || "").length > 1 || /^\w/.test(a[3])) a[3] = p(a[3], null, null, b);
                    ...
                    filter: {
                        PSEUDO: function(a, b, c, d) {
                            ...
                            else if (e === "contains") return (a.textContent || a.innerText || p.getText([a]) || "").indexOf(b[3]) >= 0;
                            else if (e === "not") {
                                b = b[3];
                                c = 0;
                        ...
                        CHILD: function(a, b) {
                            ...
                            case "nth":
                                ...
                                if (g && (g.sizcache !== f || !a.nodeIndex)) {
                                    for (var h = 0,
                                    d = g.firstChild; d; d = d.nextSibling) if (d.nodeType === 1) d.nodeIndex = ++h;
                                    g.sizcache = f
                                }
                                d = a.nodeIndex - e;
                ...
                s;
                for (s in j.match) j.match[s] = RegExp(j.match[s].source + /(?![^\[]*\])(?![^\(]*\))/.source),
                j.leftMatch[s] = RegExp(/(^(?:.|\r|\n)*?)/.source + j.match[s].source.replace(/\\(\d+)/g, B));
                var r = function(a, b) {
                ...
                m.documentElement.compareDocumentPosition ? w = function(a, b) {
                    return a === b ? (g = true, 0) : !a.compareDocumentPosition || !b.compareDocumentPosition ? a.compareDocumentPosition ? -1 : 1 : a.compareDocumentPosition(b) & 4 ? -1 : 1
                }: (w = function(a, b) {
                    if (a === b) return g = true,
                    0;
                    ...
                    for (; h;) e.unshift(h),
                    h = h.parentNode;
                    for (h = d; h;) f.unshift(h),
                    h = h.parentNode;
                    c = e.length;
                    d = f.length;
                    for (h = 0; h < c && h < d; h++) if (e[h] !== f[h]) return A(e[h], f[h]);
                ...
                p.getText = function(a) {
                    for (var b = "",
                    c, d = 0; a[d]; d++) c = a[d],
                    c.nodeType === 3 || c.nodeType === 4 ? b += c.nodeValue: c.nodeType !== 8 && (b += p.getText(c.childNodes));
                    return b
                }; (function() {
                    var a = m.createElement("div"),
                ...
                function() {
                    ...
                    if (! (b.querySelectorAll && b.querySelectorAll(".TEST").length === 0)) {
                        p = function(b, c, d, e) {
                            ...
                            if (!e && !p.isXML(c)) {
                                var f = /^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);
                                if (f && (c.nodeType === 1 || c.nodeType === 9)) if (f[1]) return r(c.getElementsByTagName(b), d);
                ...
                p.contains = m.documentElement.contains ?
                function(a, b) {
                ...
                var y = function(a, b) {
                    for (var c, d = [], e = "", f = b.nodeType ? [b] : b; c = j.match.PSEUDO.exec(a);) e += c[0],
            ...
            c.fn.extend({
                find: function(a) {
                    ...
                    if (typeof a !== "string") return c(a).filter(function() {
                        for (d = 0, e = b.length; d < e; d++) if (c.contains(b[d], this)) return true
                    });
                    var f = this.pushStack("", "find", a),
                    g,
                    h,
                    k;
                    for (d = 0, e = this.length; d < e; d++) if (g = f.length, c.find(a, this[d], f), d > 0) for (h = g; h < f.length; h++) for (k = 0; k < g; k++) if (f[k] === f[h]) {
                        f.splice(h--, 1);
                        break
                    }
                    return f
                ...
                not: function(a) {
                    return this.pushStack(N(this, a, false), "not", a)
                },
                filter: function(a) {
                ...
                closest: function(a, b) {
                    ...
                    if (c.isArray(a)) {
                        ...
                        if (g && a.length) {
                            ...
                            k[h] || (k[h] = Pa.test(h) ? c(h, b || this.context) : h);
                            for (; g && g.ownerDocument && g !== b;) {
                                for (h in k) e = k[h],
                                (e.jquery ? e.index(g) > -1 : c(g).is(e)) && d.push({
                                    selector: h,
                                    elem: g,
                                    level: o
                                });
                    ...
                    h = Pa.test(a) || typeof a !== "string" ? c(a, b || this.context) : 0;
            ...
            c.extend({
                ...
                dir: function(a, b, d) {
                    for (var e = [], a = a[b]; a && a.nodeType !== 9 && (d === l || a.nodeType !== 1 || !c(a).is(d));) a.nodeType === 1 && e.push(a),
                    a = a[b];
                    return e
                },
                nth: function(a, b, c) {
                    for (var b = b || 1,
                    e = 0; a; a = a[c]) if (a.nodeType === 1 && ++e === b) break;
                    return a
                },
            ...
            c.fn.extend({
                ...
                remove: function(a, b) {
                    for (var d = 0,
                    e; (e = this[d]) != null; d++) if (!a || c.filter(a, [e]).length) ! b && e.nodeType === 1 && (c.cleanData(e.getElementsByTagName("*")), c.cleanData([e])),
                ...
                html: function(a) {
                    if (a === l) return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(Db, "") : null;
                        ...
                        try {
                            for (var b = 0,
                            d = this.length; b < d; b++) if (this[b].nodeType === 1) c.cleanData(this[b].getElementsByTagName("*")),
                            this[b].innerHTML = a
                        } catch(e) {
                            this.empty().append(a)
                        }
                ...
                domManip: function(a, b, d) {
                    ...
                    if (this[0]) {
                        ...
                        if (f = g.childNodes.length === 1 ? g = g.firstChild: g.firstChild) {
                            ...
                            j = o - 1; f < o; f++) d.call(b ? c.nodeName(this[f], "table") ? this[f].getElementsByTagName("tbody")[0] || this[f].appendChild(this[f].ownerDocument.createElement("tbody")) : this[f] : this[f], e.cacheable || o > 1 && f < j ? c.clone(g, true, true) : g)
                        }
            ...
            c.buildFragment = function(a, b, d) {
                ...
                if (a.length === 1 && typeof a[0] === "string" && a[0].length < 512 && h === m && a[0].charAt(0) === "<" && !Sa.test(a[0]) && (c.support.checkClone || !Ta.test(a[0]))) f = true,
                (g = c.fragments[a[0]]) && g !== 1 && (e = g);
            ...
            function(a, b) {
                c.fn[a] = function(d) {
                    ...
                    if (f && f.nodeType === 11 && f.childNodes.length === 1 && d.length === 1) return d[b](this[0]),
                    this;
                    else {
                        for (var f = 0,
                        g = d.length; f < g; f++) {
            ...
            c.extend({
                ...
                clean: function(a, b, d, e) {
                    ...
                    for (var f = [], g, h = 0, k; (k = a[h]) != null; h++) if (typeof k === "number" && (k += ""), k) {
                        if (typeof k === "string") if (Fb.test(k)) {
                            ...
                            if (!c.support.tbody) {
                                j = Eb.test(k);
                                o = g === "table" && !j ? l.firstChild && l.firstChild.childNodes: o[1] === "<table>" && !j ? l.childNodes: [];
                        ...
                        var q;
                        if (!c.support.appendChecked) if (k[0] && typeof(q = k.length) === "number") for (g = 0; g < q; g++) xa(k[g]);
                        else xa(k);
                    ...
                    if (d) {
                        ...
                        for (h = 0; f[h]; h++) e && c.nodeName(f[h], "script") && (!f[h].type || f[h].type.toLowerCase() === "text/javascript") ? e.push(f[h].parentNode ? f[h].parentNode.removeChild(f[h]) : f[h]) : (f[h].nodeType === 1 && (b = c.grep(f[h].getElementsByTagName("script"), a), f.splice.apply(f, [h + 1, 0].concat(b))), d.appendChild(f[h]))
                    }
                    return f
                },
                cleanData: function(a) {
                    ...
                    k = 0,
                    o; (o = a[k]) != null; k++) if (!o.nodeName || !c.noData[o.nodeName.toLowerCase()]) if (d = o[c.expando]) {
            ...
            c.fn.css = function(a, b) {
                return arguments.length === 2 && b === l ? this: c.access(this, a, b, true,
                function(a, b, f) {
            ...
            c.extend({
                ...
                style: function(a, b, d, e) {
                    if (a && !(a.nodeType === 3 || a.nodeType === 8 || !a.style)) {
                        ...
                        if (d !== l) {
                            e = typeof d;
                            if (e === "string" && (f = Kb.exec(d))) d = +(f[1] + 1) * +f[2] + parseFloat(c.css(a, b)),
                            e = "number";
                            if (! (d == null || e === "number" && isNaN(d))) if (e === "number" && !c.cssNumber[g] && (d += "px"), !k || !("set" in k) || (d = k.set(a, d)) !== l) try {
                                h[b] = d
                            } catch(j) {}
            ...
            c.extend({
                ...
                ajax: function(a, b) {
                    function d(a, b, d, m) {
                        if (y !== 2) {
                            ...
                            if (d) {
                                ...
                                for (; z[0] === "*";) z.shift(),
                                F === l && (F = x.mimeType || v.getResponseHeader("content-type"));
                                if (F) for (C in V) if (V[C] && V[C].test(F)) {
                                    z.unshift(C);
                                    break
                                }
                                if (z[0] in d) D = z[0];
                            ...
                            if (a >= 200 && a < 300 || a === 304) {
                                ...
                                q = true;
                                    ...
                                    U;
                                    for (G = 1; G < O; G++) {
                                        if (G === 1) for (I in F.converters) typeof I === "string" && (C[I.toLowerCase()] = F.converters[I]);
                                        H = P;
                                        P = L[G];
                                        if (P === "*") P = H;
                                        else if (H !== "*" && H !== P) {
                                            M = H + " " + P;
                                            Q = C[M] || C["* " + P];
                                            if (!Q) for (S in U = l, C) if (J = S.split(" "), J[0] === H || J[0] === "*") if (U = C[J[1] + " " + P]) {
                                                S = C[S];
                            ...
                            k.resolveWith(f, [t, m]);
                            E && (g.trigger("ajaxComplete", [t, e]), --c.active || c.event.trigger("ajaxStop"))
                        }
                    }
                    ...
                    t = {
                        ...
                        getResponseHeader: function(a) {
                            var b;
                            if (y === 2) {
                                if (!s) for (s = {}; b = Ob.exec(r);) s[b[1].toLowerCase()] = b[2];
                                b = s[a.toLowerCase()]
                            }
                            return b === l ? null: b
                        },
                    ...
                    if (e.beforeSend && (e.beforeSend.call(f, t, e) === false || y === 2)) return t.abort(),
                    false;
                    for (x in {
                        success: 1,
                        error: 1,
                ...
                param: function(a, b) {
                    ...
                    else for (var f in a) ha(f, a[f], b, e);
            ...
            function(a, b, d) {
                ...
                if (a.dataTypes[0] === "jsonp" || a.jsonp !== false && (ca.test(a.url) || b && ca.test(a.data))) {
                            ...
                            b = function(d, h) {
                                ...
                                try {
                                    if (b && (h || f.readyState === 4)) {
                                        b = l;
                                        if (g) f.onreadystatechange = c.noop,
                                        sa && delete H[g];
                                ...
                                q && e(k, j, q, m)
                            }; ! a.async || f.readyState === 4 ? b() : (g = ++Wb, sa && (H || (H = {},
                            c(j).unload(sa)), H[g] = b), f.onreadystatechange = b)
                        },
                        abort: function() {
                            b && b(0, 1)
                        }
            ...
            Yb = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
            da, Ea = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]],
            $;
            c.fn.extend({
                show: function(a, b, d) {
                    if (a || a === 0) return this.animate(O("show", 3), a, b, d);
                        ...
                        for (var d = 0,
                        e = this.length; d < e; d++) if (a = this[d], a.style) {
                            b = a.style.display;
                ...
                animate: function(a, b, d, e) {
                    ...
                    return this[f.queue === false ? "each": "queue"](function() {
                        ...
                        for (m in a) {
                            ...
                            l = a[j];
                            c.isArray(l) ? (b.animatedProperties[j] = l[1], g = a[j] = l[0], l = g) : b.animatedProperties[j] = b.specialEasing && b.specialEasing[j] || b.easing || "swing";
                            if (l === "hide" && e || l === "show" && !e) return b.complete.call(this);
                            if (d && (j === "height" || j === "width")) if (b.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], c.css(this, "display") === "inline" && c.css(this, "float") === "none") c.support.inlineBlockNeedsLayout ? (l = Fa(this.nodeName), l === "inline" ? this.style.display = "inline-block": (this.style.display = "inline", this.style.zoom = 1)) : this.style.display = "inline-block"
                        }
                        if (b.overflow != null) this.style.overflow = "hidden";
                        for (m in a) if (d = new c.fx(this, b, m), l = a[m], Xb.test(l)) d[l === "toggle" ? e ? "show": "hide": l]();
                        else j = Yb.exec(l),
                        q = d.cur(),
                        j ? (l = parseFloat(j[2]), r = j[3] || (c.cssNumber[m] ? "": "px"), r !== "px" && (c.style(this, m, (l || 1) + r), q *= (l || 1) / d.cur(), c.style(this, m, q + r)), j[1] && (l = (j[1] === "-=" ? -1 : 1) * l + q), d.custom(q, l, r)) : d.custom(q, l, "");
                        return true
                    })
                },
                stop: function(a, b) {
                    ...
                    this.each(function() {
                        var a = c.timers,
                        e = a.length;
                        for (b || c._unmark(true, this); e--;) if (a[e].elem === this) {
                            if (b) a[e](true);
                            a.splice(e, 1)
                        }
                    });
            ...
            c.fx.prototype = {
                ...
                step: function(a) {
                    ...
                    if (a || b >= f.duration + this.startTime) {
                        ...
                        return false
                    } else f.duration == Infinity ? this.now = b: (a = b - this.startTime, this.state = a / f.duration, this.pos = c.easing[f.animatedProperties[this.prop]](this.state, a, 0, 1, f.duration), this.now = this.start + (this.end - this.start) * this.pos),
                    this.update();
                    return true
                }
            };
            ...
            var Zb = /^t(?:able|d|h)$/i,
            cb = /^(?:body|html)$/i;
            c.fn.offset = "getBoundingClientRect" in m.documentElement ?
            function(a) {
                var b = this[0],
                d;
                ...
                j = b.offsetLeft; (b = b.parentNode) && b !== h && b !== g;) {
                    ...
                    if (b === e) {
                        k += b.offsetTop;
                        j += b.offsetLeft;
                        if (c.offset.doesNotAddBorder && (!c.offset.doesAddBorderForTableAndCells || !Zb.test(b.nodeName))) k += parseFloat(d.borderTopWidth) || 0,
                ...
                if (d.position === "relative" || d.position === "static") k += h.offsetTop,
                j += h.offsetLeft;
            ...
            c.offset = {
                ...
                setOffset: function(a, b, d) {
                    ...
                    k = c.css(a, "left"),
                    j = {},
                    l = {}; (e === "absolute" || e === "fixed") && c.inArray("auto", [h, k]) > -1 ? (l = f.position(), e = l.top, k = l.left) : (e = parseFloat(h) || 0, k = parseFloat(k) || 0);
            ...
            function(a, b) {
                ...
                c.fn[d] = function(b) {
                    ...
                    return this.each(function() { (g = ja(this)) ? g.scrollTo(!a ? b: c(g).scrollLeft(), a ? b: c(g).scrollTop()) : this[d] = b
                    })
                }
            });
            c.each(["Height", "Width"],
    ...
    q(function() { (function(j) {
            var l = {},
            A = decodeURIComponent;
            q.each(j.attr("src").split("#").pop().split("&"),
            function() {
                var j = (this + "").split("=");
                l[A(j[0])] = A(j[1])
            });
        ...
        window.giffy_bp_0013 = {
            ...
            init: function() {
                ...
                for (i = 0; i < 8; i++) j = "images/subball" + (i + 1) + ".png",
                giffy_bp_0013.subBallImageResource[i] = new Image,
                giffy_bp_0013.subBallImageResource[i].src = j;
                for (i = 0; i < 20; i++) {
                ...
                q("html").mousemove(function(j) {
                    ...
                    if (giffy_bp_0013.waitCnt == 0 && giffy_bp_0013.actionCount[giffy_bp_0013.curBallIdx] == 0) giffy_bp_0013.waitCnt = 2,
            ...
            action: function() {
                ...
                case 1:
                    ...
                    giffy_bp_0013.animateY(giffy_bp_0013.ball[i], giffy_bp_0013.mouseY, 100, "swing",
                    function() {
                ...
                case 2:
                    ...
                    for (n = 0; n < 3; n++) giffy_bp_0013.move(giffy_bp_0013.subBall[i][n], l),
                    giffy_bp_0013.animateRandomXY(giffy_bp_0013.subBall[i][n], l.left - 30, l.left + 30, l.top, l.top + 30, 200, "swing",
                    function() {
                        q(this).attr("subno") == 2 && (giffy_bp_0013.actionCount[q(this).attr("no")] = 3)
                    }),
                    j = giffy_bp_0013.subBallImageResource[giffy_bp_0013.getRandomNum(8)],
                    giffy_bp_0013.subBall[i][n].css({
                        background: "url(" + j.src + ") no-repeat",
                        height: j.height,
                        width: j.width
                    }),
                    N || giffy_bp_0013.setOpacity(giffy_bp_0013.subBall[i][n], 1),
                    giffy_bp_0013.setVisible(giffy_bp_0013.subBall[i][n]);
                    giffy_bp_0013.actionCount[i] = 0;
                    break;
                case 3:
                    for (n = 0; n < 3; n++) l = giffy_bp_0013.subBall[i][n].position(),
                    N ? giffy_bp_0013.animateRandomXY(giffy_bp_0013.subBall[i][n], l.left, l.left, l.top + 10, l.top + 50, 1E3, "linear",
                    function() {
                        q(this).attr("subno") == 2 && (giffy_bp_0013.actionCount[q(this).attr("no")] = 4)
                    }) : giffy_bp_0013.animateRandomXYFadeout(giffy_bp_0013.subBall[i][n], l.left, l.left, l.top + 10, l.top + 50, 1E3, "linear",
                    function() {
                        q(this).attr("subno") == 2 && (giffy_bp_0013.actionCount[q(this).attr("no")] = 4)
                    });
                    giffy_bp_0013.actionCount[i] = 0;
            ...
            animateRandomXYFadeout: function(j, l, q, r, u, w, z, N) {
                giffy_bp_0013.animateXYFadeout(j, l + giffy_bp_0013.getRandomNum(q - l), r + giffy_bp_0013.getRandomNum(u - r), w, z, N)
            },
